        ...
        <div class="main-menu-content">
            ...
            @endif
                ...
                @if($department==1)
                  ...
                  @endif
                         @php $attendance = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'attendance'])->count();
                         @endphp   
                @if($attendance==1)
                ...
                @if($payrol==1)
     <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Content">PayRoll</span></a>
                    <ul class="menu-content">

                  <li class={{ Request::is('admin/payroll')? 'active' : '' }}>
                    <a href="{{url('admin/payroll')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">Hourly Payroll</span>
                    </a>
                  </li>
                  <li class={{ Request::is('admin/daily_payroll')? 'active' : '' }}>
                    <a href="{{url('admin/daily_payroll')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">Daily Payroll</span>
                    </a>
                  </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Content">Acc Threshold</span></a>
                    <ul class="menu-content">
                        <li class={{ Request::is('admin/accumulate_threshold')? 'active' : '' }}>
                            <a href="{{url('admin/accumulate_threshold')}}">
                                <i class="feather icon-list"></i>
                                <span class="menu-title" data-i18n="services">Fortnightly Threshold</span>
                            </a>
                        </li>
                        
                        <li class={{ Request::is('admin/monthly_accumulate_threshold')? 'active' : '' }}>
                                    <a href="{{url('admin/monthly_accumulate_threshold')}}">
                                        <i class="feather icon-list"></i>
                                        <span class="menu-title" data-i18n="services">Monthly Threshold</span>
                                    </a>
                        </li>
                    </ul>
                </li>
...
@if($thresold==1)
                   ...
                   <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Content">Deduction</span></a>
	<ul class="menu-content">
               ...
               <li class={{ Request::is('admin/deduction')? 'active' : '' }}>
                    <a href="{{route('deduction')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">Tax Deduction</span>
                    </a>
               </li>

		        <li class={{ Request::is('admin/one_time_deduction')? 'active' : '' }}>
                    <a href="{{url('admin/one_time_deduction')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">One Time Deduction</span>
                    </a>
               </li>
               
               <li class={{ Request::is('admin/continuous_deduction')? 'active' : '' }}>
                    <a href="{{url('admin/continuous_deduction')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">continuous_deduction Deduction</span>
                    </a>
               </li>
                @php
                    $loan_id = auth::user()->user_role;
                    $res = strcmp($loan_id,'admin')
                @endphp
                    @if($res==0)
                    <li class={{ Request::is('admin/loan')? 'active' : '' }}>
                    <a href="{{route('admin.loan')}}">
                        <i class="feather icon-list"></i>
                        <span class="menu-title" data-i18n="services">Periodic Deduction</span>
                    </a>
                  </li>
                @endif
	</ul>
                  ...
                  @endif
            <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Content">Bonus</span></a>
	            <ul class="menu-content">
                     ...
                     @if($bounus_add==1)
                      ...
                      <li class={{ Request::is('admin/viewbonus')? 'active' : '' }}>
                        <a href="{{route('viewbonus')}}">
                            <i class="feather icon-list"></i>
                            <span class="menu-title" data-i18n="services">View Bonus</span>
                        </a>
                      </li>
                     @endif
                </ul>
...
@if($holidays)
     <li class=" nav-item"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Content">Paid Leaves</span></a>
                    <ul class="menu-content">
                        ...
                        <li class={{ Request::is('admin/vacation-leave')? 'active' : '' }}><a href="{{url('admin/vacation-leave')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Grid">Vacation  Leave</span></a>
                        </li>
                        <li class="{{ Request::is('admin/holidays')? 'active' : '' }}"><a href="{{ url('admin/holidays') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Grid">Holidays</span></a>
                        </li>
                        <li class="{{ Request::is('admin/maternity')? 'active' : '' }}"><a href="{{ url('admin/maternity') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Grid">Maternity Leave</span></a>
                        </li>
                    </ul>
                </li>  
                @endif
                  @php $notice = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'notices'])->count();@endphp   
@if($notice==1)
...
@if(auth::user()->user_role=='admin')
                ...
                <li class={{ Request::is('admin/department/permission')? 'active' : '' }}>
                    <a href="{{url('admin/department/permission')}}">
                        <i class="feather icon-lock"></i>
                        <span class="menu-title" data-i18n="services">Super Department </span>
                    </a>
                </li>
                @endif
   @php $report = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'report'])->count();@endphp   
@if($report==1)
                <li class=" nav-item"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Content">Report</span></a>
                    <ul class="menu-content">
                        <li class="{{ Request::is('admin/deduction-report')? 'active' : '' }}"><a href="{{url('admin/deduction-report')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Grid">Deductions & Bonus</span></a>
                        </li>
                    </ul>
                </li>
@endif
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Content">Security</span></a>
                    <ul class="menu-content">

                        <li class={{ Request::is('admin/ip_managment')? 'active' : '' }}>
                            <a href="{{url('admin/ip_managment')}}">
                                <i class="feather icon-list"></i>
                                <span class="menu-title" data-i18n="services">IP Managment</span>
                            </a>
                        </li>
                        <!--<li class={{ Request::is('admin/mac_address_managment')? 'active' : '' }}>-->
                        <!--    <a href="{{url('admin/mac_address_managment')}}">-->
                        <!--        <i class="feather icon-list"></i>-->
                        <!--        <span class="menu-title" data-i18n="services">Mac Address Managment</span>-->
                        <!--    </a>-->
                        <!--</li>-->
                    </ul>
                </li>
